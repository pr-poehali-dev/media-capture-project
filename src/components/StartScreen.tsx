...
const StartScreen = ({ onStart }: StartScreenProps) => {
  return (
    <div className="relative flex flex-col justify-center items-center min-h-screen p-6 bg-gradient-to-br from-blue-50 via-white to-blue-100 overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center flex-1">
        <h1 className="text-6xl md:text-8xl font-bold text-blue-900 animate-pulse-gentle mb-4 text-center drop-shadow-lg">
          IMPERIA PROMO
        </h1>
        <div className="text-2xl md:text-3xl font-light text-blue-700 text-center animate-fade-in opacity-90">
